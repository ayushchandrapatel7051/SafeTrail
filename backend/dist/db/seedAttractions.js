...
async function seedAttractions() {
    ...
    try {
        for (const attraction of attractions) {
            await query(`INSERT INTO attractions (city_id, name, description, category, latitude, longitude, rating, estimated_duration, best_time_to_visit, entry_fee)
...
//# sourceMappingURL=seedAttractions.js.map