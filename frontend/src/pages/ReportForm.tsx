        ...
        <div className="p-6 max-w-6xl mx-auto">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              Help protect the travel community by reporting safety concerns
            </p>
          </div>
                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800">
                      Our team verifies all reports before publishing.
                    </p>
                  </div>
                  <div>
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            <SelectTrigger id="place" className="h-11">
                              <SelectValue
                                placeholder={selectedCity ? 'Select place' : 'Select city first'}
                              />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        {locationStatus === 'success' && (
                          <Alert className="bg-green-50 border-green-200">
                            ...
                            <AlertDescription className="text-green-800">
                              Location captured successfully at {formData.latitude},{' '}
                              {formData.longitude}
                            </AlertDescription>
                          </Alert>
                        )}
