        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="text-center py-12">
              <p className="text-muted-foreground">No emergency services found for this location.</p>
            </CardContent>
          </Card>
        ) : (
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {service.police_number && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <a href={`tel:${service.police_number}`} className="text-blue-600 hover:underline">
                          {service.police_number}
                        </a>
                      </div>
                    )}
                    {service.ambulance_number && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <a href={`tel:${service.ambulance_number}`} className="text-blue-600 hover:underline">
                          {service.ambulance_number}
                        </a>
                      </div>
                    )}
                    {service.fire_number && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <a href={`tel:${service.fire_number}`} className="text-blue-600 hover:underline">
                          {service.fire_number}
                        </a>
                      </div>
                    )}
                    {service.women_helpline && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <a href={`tel:${service.women_helpline}`} className="text-blue-600 hover:underline">
                          {service.women_helpline}
                        </a>
                      </div>
                    )}
                  ...
                  {service.nearest_police_name && (
                    <div className="pt-2 border-t">
                      <p className="text-xs font-medium text-muted-foreground mb-1">Nearest Police Station</p>
