...
const steps = [
  {
    ...
    description: "Enter the city or area you're planning to visit. Our system will load safety data for that region.",
  },
  {
    icon: MapPin,
    step: "02",
    title: "Explore the Safety Map",
    description: "View color-coded zones showing safety levels. Green is safe, yellow needs caution, red is risky.",
  },
  {
    icon: Shield,
    step: "03",
    title: "Stay Informed",
    description: "Receive real-time alerts and check safety scores for specific places like hotels, transit, and attractions.",
  },
  {
    icon: CheckCircle,
    step: "04",
    title: "Report & Contribute",
    description: "Help others by reporting incidents. Verified reports improve safety data for the entire community.",
  },
];
